...
public class StudyRoom extends Resource {
    public StudyRoom(String resourceId, String name, String type, String location,
    ...
    @Override
    public String getBookingRules() { return "Study rooms may be booked for up to 4 hours per session."; }
}
